...
class ContactAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    ...
    switch ($operation) {
      case 'view':
        return AccessResult::allowedIfHasPermission($account, 'view club_contact entity');

      case 'update':
        return AccessResult::allowedIfHasPermission($account, 'edit club_contact entity');

      case 'delete':
        return AccessResult::allowedIfHasPermission($account, 'delete club_contact entity');
    }
